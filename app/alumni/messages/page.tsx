...
function AlumniMessagesContent() {
  ...
  return (
    <div className="flex h-screen w-full bg-gray-50 overflow-hidden">
      {/* Sidebar (hidden when opened from Show) */}
      {!chatOnlyMode && (
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              size="sm"
              onClick={() => { setSelectedRequest(null); setShowNewChat(!showNewChat) }}
      ...
      <div className="flex-1 flex flex-col">
        {selectedUser ? (
          <>
            ...
            {/* Bottom Actions */}
            {selectedRequest ? (
              <div className="p-4 border-t border-gray-200 bg-white flex items-center gap-2 justify-end">
                <Button 
                  variant="outline"
      ...
      {/* New Chat Sidebar (hidden when opened from Show) */}
      {!chatOnlyMode && showNewChat && (
