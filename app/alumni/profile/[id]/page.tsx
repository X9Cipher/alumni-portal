      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Removed extra sections; everything is inside the header card now */}
          ...
          <section>
            <h3 className="text-lg font-semibold text-[#a41a2f] mb-3">Contact Information</h3>
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-center gap-2"><Mail className="w-4 h-4 text-gray-500" /><span>{profile.email}</span></div>
              {profile.phone && (<div className="flex items-center gap-2"><Phone className="w-4 h-4 text-gray-500" /><span>{profile.phone}</span></div>)}
              {profile.location && (<div className="flex items-center gap-2"><MapPin className="w-4 h-4 text-gray-500" /><span>{profile.location}</span></div>)}
            </div>
          </section>
